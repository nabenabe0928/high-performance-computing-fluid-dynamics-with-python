...
\begin{figure}[H]
  \vspace{-1mm}
  \centering
  \includegraphics[width=0.56\textwidth]{../log/couette_flow/fig/couette_flow_joint.pdf}
  \vspace{-5mm}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.56\textwidth]{../log/poiseuille_flow/fig/poiseuille_flow_joint.pdf}
  \vspace{-3mm}
  \caption{The velocity evolution at
  $x = 25$ in the lattice grid size of $(50, 50)$.
  The relaxation term $\omega$ is set to $1.0$.
