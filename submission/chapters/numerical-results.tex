...
the velocity is calculated as follows\cite{}:
\begin{equation}
  \begin{aligned}
    u_x(y, t) &= 
    \epsilon \exp\biggl(
...
\begin{figure}[H]
  \begin{center}
    ...
    \caption{The velocity evolution for the sinusoidal velocity at
      ...
      and the $x$-axis shows the magnitude of velocity at 
...
and the waiting for the synchronization as described in Amdahl's law\cite{}.
Such slow down is also seen in Figure~\ref{fig:sliding-lid-scaling}.
\begin{figure}[b]
  \centering
  \includegraphics[width=0.48\textwidth]{../log/sliding_lid_W0.10_visc0.03_size300/fig/scaling_test.pdf}
