...
Besides, momentum fluctuations decay exponentially in shear wave decay settings~\cite{palmer1994transverse, hess2002determining}:
\begin{equation}
  \begin{aligned}
    Q(x, t) &=
...
\begin{figure}[H]
  \begin{center}
    ...
    and takes the maximum magnitude of
    $|| u_x ||$ and $|| \rho - \rho_0 ||$
    to fit the curve.
